	...
	<div class="row">
		<div class="col-xs-6">
			<div class="form-group" style="text-align: left !important;">
				<label for="linguisticTerm">Linguistic Term</label>
				<input type="text" class="form-control" id="linguisticTermOuput" name="linguisticTerm" placeholder="Enter Linguistic Term">
			</div>
			
			<div class="form-group" style="text-align: left !important;">
				<label for="linguisticTermFunctionIDOuput">Linguistic Term Function</label>
				<select id="linguisticTermFunctionIDOuput" class="form-control" name="linguisticTermFunction" onchange="changePlaceholder(this, 'linguisticTermFunctionValuesOuput')">
			...
			<div class="form-group" style="text-align: left !important;">
				<label for="linguisticTermFunctionValuesOuput">Values</label>
				<input type="text" class="form-control" id="linguisticTermFunctionValuesOuput" name="linguisticTermFunctionValuesOuput" placeholder="trian min mid max">
			</div>
			
			<div class="form-group" style="text-align: left !important;">
				<div class="row">
					<div class="col-xs-6">
						<button type="button" class="btn btn-primary" id="addLinguisticTermOuput">
							Add Linguistic Term <span class="glyphicon glyphicon-plus"></span>
						</button>
					</div>
					<div class="col-xs-6">
						<button type="button" class="btn btn-default btn-block" id="plotGraphOutputTerm">
